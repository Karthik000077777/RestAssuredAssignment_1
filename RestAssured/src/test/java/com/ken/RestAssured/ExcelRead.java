...
public class ExcelRead {
	...
	public static void main(String[] args) {
		String filePath = "C:\\Users\\YKAREDDY\\Documents\\DataApiTesting.xlsx";
		...
		int reqDescription = GetExcelData.returnColName(dataTable, "Req.Description");
		int execute = GetExcelData.returnColName(dataTable, "Execute");
